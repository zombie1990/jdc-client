...
public class Auth {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/* identity packet */
			EAPPacket identityPacket = new EAPPacket(EAPPacket.RESPONSE, EAPPacket.IDENTITY, EAPPacket.IDENTITY_TYPE, username, EAPOLPacket.VERSION_1, EAPOLPacket.EAP_PACKET);
			identityPacket.datalink = ether;
			/* md5-challenge packet */
			EAPPacket md5challengePacket = new EAPPacket(EAPPacket.RESPONSE, EAPPacket.MD5_CHALLENGE, EAPPacket.MD5_CHALLENGE_TYPE, password, EAPOLPacket.VERSION_1, EAPOLPacket.EAP_PACKET);
			md5challengePacket.datalink = ether;
			/* handshake packet */
			EAPPacket handshakePacket = new EAPPacket(EAPPacket.RESPONSE, (byte)0x03, EAPPacket.HANDSHAKE_TYPE, username, EAPOLPacket.VERSION_1, EAPOLPacket.EAP_PACKET);
			...
			while(true) {
				...
				if(Arrays.equals(eapHeader, IDENTITY_REQUEST)) {
					...
					System.out.print("sending username...");
				}
