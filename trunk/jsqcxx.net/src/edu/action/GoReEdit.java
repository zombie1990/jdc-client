...
public class GoReEdit extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(manageType == 0) {
			temp.put("xxjj", "学校简介");temp.put("ldgh", "领导关怀");temp.put("gzzd", "规章制度");temp.put("bxcg", "办学成果");
		}
		else if(manageType == 1) {
			temp.put("zhxw", "综合新闻");
		}
		else if(manageType == 2) {
			temp.put("kyda", "科研档案");temp.put("jxsj", "教学设计");temp.put("stzx", "试题中心");temp.put("jxdjt", "教学大家谈");temp.put("jsfc", "教师风采");
		}
		else if(manageType == 3) {
			temp.put("pkhz", "贫困互助");temp.put("jjzx", "家教在线");temp.put("wdsh", "我的书画");temp.put("wdwz", "我的文章");temp.put("zwbs", "征文比赛");
		}
		else if(manageType == 4) {
			temp.put("xytp", "校园图片");temp.put("spwj", "视频文件");temp.put("hdtp", "活动图片");
		}
		else if(manageType == 5) {
			temp.put("jxrj", "教学软件");temp.put("jxsck", "教学素材库");temp.put("cyrj", "常用软件");
		}
		else if(manageType == 6) {
			temp.put("bw", "博文");temp.put("xzwj", "校长文集");
		}
		types = temp;
		if(null != uuid)
