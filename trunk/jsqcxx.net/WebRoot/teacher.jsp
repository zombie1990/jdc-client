			...
			<div>
				<table cellpadding="0" cellspacing="0" style="padding: 20px 0 0 0">
					<tr>
						<td valign="top">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td id="left-frame">
										<ul>
											<li><s:a href="%{findKYDA}">科研档案</s:a></li>
											<li><s:a href="%{findJXSJ}">教学设计</s:a></li>
											<li><s:a href="%{findSTZX}">试题中心</s:a></li>
											<li><s:a href="%{findJXDJT}">教学大家谈</s:a></li>
											<li><s:a href="%{findJSFC}">教师风采</s:a></li>
										</ul>
									</td>
								</tr>
						...
						<td valign="top">
							<div id="right-frame">
								<div style="font-size: 16px;font-weight: bolder;margin: 10px 10px 10px 10px;color: #888888">教师教学</div>
