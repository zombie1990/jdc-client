			...
			<div>
				<table cellpadding="0" cellspacing="0" style="padding: 20px 0 0 0">
					<tr>
						<td valign="top">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td id="left-frame">
										<ul>
											<li><s:a href="%{findJXRJ}">教学软件</s:a></li>
											<li><s:a href="%{findJXSCK}">教学素材库</s:a></li>
											<li><s:a href="%{findCYRJ}">常用软件</s:a></li>
										</ul>
									</td>
								</tr>
						...
						<td valign="top">
							<div id="right-frame">
								<div style="font-size: 16px;font-weight: bolder;margin: 10px 10px 10px 10px;color: #888888">资源下载</div>
