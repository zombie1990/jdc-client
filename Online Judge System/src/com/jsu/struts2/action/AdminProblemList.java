 ...
 *
 */
public class AdminProblemList extends ActionSupport {
	...
	private String contestProblem = "NO";
	...
	public String execute() {
		...
		try {
			...
			if("NO".equals(contestProblem)) {
				...
				List<Problem> list = problemDAO.getPageProblems((pageNum-1)*100, contestProblem);
				problems = list;
