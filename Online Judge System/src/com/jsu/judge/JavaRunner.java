...
/**
 * Be sure that your timeLimit need more 300~500ms for JVM.
 * @author: Luo Qiang
 * Last Modified: 2010-2-8
 */
public class JavaRunner {

	private final static Logger log = Logger.getLogger(JavaRunner.class);
	...
	private static String RUN_JAVA = JUDGE_BASE + "bin\\SUN\\bin\\java.exe -classpath " + JUDGE_BASE + "temp\\";
	...
	public static int run(String runId, long timeLimit, long memoryLimit, File input, File output) {
		...
		long after = before;
		try {
			process = runtime.exec(RUN_JAVA + runId + " Main");
