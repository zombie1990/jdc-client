...
//						codeDAO.makePersistent(code);
						/**** save contest's reference if contest not null ****/
						if ( contest != null ) {
				...
				if ( contest != null ) {
					...
					switch(result) {
						case Presentation_Error :
							statics.setPE(statics.getPE()+1);break;
						case Time_Limit_Exceeded :
							statics.setTLE(statics.getTLE()+1);break;
						case Memory_Limit_Exceeded :
							statics.setMLE(statics.getMLE()+1);break;
						case Wrong_Answer :
							statics.setWA(statics.getWA()+1);break;
						case Runtime_Error :
							statics.setRE(statics.getRE()+1);break;
						default : 
							statics.setSE(statics.getSE()+1);break;
					}
					statics.setTotal(statics.getTotal()+1);
					sDAO.makePersistent(statics);
					/* save reference Result */
