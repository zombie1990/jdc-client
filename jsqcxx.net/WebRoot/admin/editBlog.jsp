				...
				<table cellpadding="0" cellspacing="0" style="margin: 20px 0 0 0;">
					...
					<tr>
						<td valign="top" id="edit-right-frame" width="800">
							...
							<div>
							<s:form action="addBlog" method="post">
								<s:hidden name="manageType" value="%{manageType}"></s:hidden>
								<s:textfield label="标题" name="title" size="60" labelposition="top" />
								<s:textfield label="标题图片" name="leftPicURL" size="30" labelposition="top" />
								<s:textfield label="选显图片" name="rightPicURL" size="30" labelposition="top" />
								<s:select list="types" name="type" label="文章类型" labelposition="top" />
								<label for="editor1">内容:</label>
								<textarea class="ckeditor" name="content">请在这里写内容</textarea>
