			...
			<div>
				<table cellpadding="0" cellspacing="0" style="padding: 20px 0 0 0">
					<tr>
						<td valign="top">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td id="left-frame">
										<ul>
											<li><s:a href="%{findXYTP}">校园图片</s:a></li>
											<li><s:a href="%{findSPWJ}">视频文件</s:a></li>
											<li><s:a href="%{findHDTP}">活动图片</s:a></li>
										</ul>
									</td>
								</tr>
						...
						<td valign="top">
							<div id="right-frame">
								<div style="font-size: 16px;font-weight: bolder;margin: 10px 10px 10px 10px;color: #888888">图片中心</div>
