			...
			<div>
				<table cellpadding="0" cellspacing="0" style="padding: 20px 0 0 0">
					<tr>
						<td valign="top">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td id="left-frame">
										<ul>
											<li><s:a href="%{findXXJJ}">校园简介</s:a></li>
											<li><s:a href="%{findLDGH}">领导关怀</s:a></li>
											<li><s:a href="%{findGZZD}">规章制度</s:a></li>
											<li><s:a href="%{findBXCG}">办学成果</s:a></li>
										</ul>
									</td>
								</tr>
						...
						<td valign="top">
							<div id="right-frame">
								<div style="font-size: 16px;font-weight: bolder;margin: 10px 10px 10px 10px;color: #888888;padding:0 0 0 10px;">学校概况</div>
